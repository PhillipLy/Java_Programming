...
public class Week_10_Homework {
	...
	public void keepTrackHistory(int winsNumber, int losesNumber) {

		JOptionPane.showMessageDialog(null, "You had " + winsNumber
				+ " correct guesses. And  " + losesNumber + " wrong guesses!");
	}
	...
	public static void OneThrow() {
		...
		JOptionPane.showMessageDialog(null, "The current number is "
				+ numberValue);
