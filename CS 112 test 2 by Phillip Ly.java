...
public class guess_a_number_game {
	...
	public static void main(String[] args) {
		...
		DiceSuperClass myDice = new DiceSuperClass(bounces);
		DoubleDice_Test2 DoubleDice = new DoubleDice_Test2(diceNumber);
		TrippleDice_Test2 TripleDice = new TrippleDice_Test2(diceNumber);
		...
		while (choice == 1) {
			...
			if (tries % 2 == 0) {
				...
				if (scorecard == 1) {
					...
					// keeping tracks of wins and loses, games history, and
					// results
					myDice.keepTrackHistory(userWins, compWins, tries,
							userChoice, compChoice);
					
					DoubleDice.toString(userChoice, compChoice);
					TripleDice.toString(userChoice, compChoice);
)
...
public class DoubleDice_Test2 extends DiceSuperClass {

	public DoubleDice_Test2(int dices) {
		super(dices);
	...
	public static void main(String[] args) {		
		...
		@Override
		public String toString(int[] playersChoice, int[] cpuChoice) {

		
			
			for (int i = 0; i <= triesTotal; i++) {

				String printHistory = JOptionPane.showMessageDialog(null, "Your guess no"
...
public class DiceSuperClass {
	...
	//declarations
		...
		private static int numberOfThrow = 0;

		
		// Constructor
		// bounceNumber is the number of bounces from the main program
		
		public DiceSuperClass (int dices)
		{
			diceNumbers = dices ;
		}
...
public class TrippleDice_Test2 extends DiceSuperClass {

	public TrippleDice_Test2(int dices) {
		super(dices);
		// TODO Auto-generated constructor stub
	}
	...
	public static void main(String[] args) {
		...
		final int numberOfThrows = 0;
		int valuePerThrow = 0;
		int[] historyOfThrows = new int[100];
